          ...
          <div className="card-paper p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-parchment-100 rounded-lg border border-amber-200">
                <p className="text-xs text-amber-600 mb-1">总捡漏次数</p>
                <p className="font-mono text-3xl font-bold text-amber-800 number-pop">
                  {stats.totalRecords}
                </p>
              </div>
              <div className="text-center p-3 bg-parchment-100 rounded-lg border border-amber-200">
                <p className="text-xs text-amber-600 mb-1">累计节省</p>
                <p className="font-mono text-3xl font-bold text-forest-700 number-pop">
